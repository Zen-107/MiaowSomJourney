...
const SCENE_HINT := "res://game/Main/start/select/level/level2/hint_2.tscn"
const SCENE_MORE := "res://game/Main/start/select/level/level2/morelevel_2.tscn"
...
func _on_a_pressed() -> void:
	...
	if not visited_buttons["B"]: next_buttons.append(button_b)
	if not visited_buttons["C"]: next_buttons.append(button_c)
	if not visited_buttons["D"]: next_buttons.append(button_d)
...
func _on_d_pressed() -> void:
	...
	var next_buttons: Array[Button] = []
	if not visited_buttons["A"]: next_buttons.append(button_a)
